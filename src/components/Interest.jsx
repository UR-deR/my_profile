...
export const Interest = (props) => (
  <div className={classNames(props.index % 2 === 0 ? 'sm:flex-row' : 'sm:flex-row-reverse', props.index === props.dataLength ? 'border-transparent' : 'border-b', 'flex', ' flex-col', ' items-center', 'border-gray-400', ' lg:w-2/3', '	 mx-auto', ' pb-10 ', 'mb-10')}>
